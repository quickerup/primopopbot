...
export class TelegramClient {
  ...
  async setWebhook(url: string, secretToken: string) {
    return this.call("setWebhook", { url, secret_token: secretToken, drop_pending_updates: true });
  }
  ...
  async sendMessage(
    ...
    for (const chunk of chunks) {
      last = await this.call("sendMessage", { chat_id: chatId, text: chunk, ...opts });
    }
    return last;
  }
  ...
  async sendPoll(
    ...
    return this.call("sendPoll", { chat_id: chatId, question, options, is_anonymous, allows_multiple_answers });
  }
